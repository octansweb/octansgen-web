            ...
            <div class="relative -mx-4 flex items-center justify-between">
                <div class="w-60 max-w-full px-4">
                    <a href="index.html" class="navbar-logo block w-full py-5">
                        <img src="/images/logo/logo-dark.png" alt="logo" class="header-logo w-full" />
                    </a>
                </div>
                  ...
                  <div
                    ...
                    <div class="flex items-center justify-end pr-16 lg:pr-0">
                        ...
                        <div class="hidden sm:flex">
                            ...
                            <button href="signup.html" disabled
                ...
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        ...
                        <p
                            ...
                            Meet OctansGen, the ultimate platform for automating short-form video production. Create
                            captivating videos with intelligent automation, customizable templates, and seamless
              ...
              <div class="wow fadeInUp flex items-center justify-center gap-4 text-center" data-wow-delay=".3s">
                ...
                <a href="javascript:void(0)"
                  ...
                  <svg class="fill-current" width="41" height="26" viewBox="0 0 41 26" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <mask id="mask0_2005_10783" style="mask-type: luminance" maskUnits="userSpaceOnUse" x="0" y="0"
                      width="41" height="26">
                ...
                <div class="w-full px-4">
                    <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                        <div class="mt-16">
                            <img src="/images/hero/octansgen-mockup.png" alt="hero"
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                        ...
                        <h2
                            ...
                            Main Features Of OctansGen
                        </h2>
                        <p class="text-base text-body-color dark:text-dark-6">
                            Discover how OctansGen revolutionizes your video content creation with powerful automation
            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".1s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Automate your video production process with OctansGen's cutting-edge technology, saving you
                            time and effort.
                        </p>
                        <a href="javascript:void(0)"
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Choose from a variety of templates and tailor them to fit your brand's unique style and
                            message.
                        </p>
                        <a href="javascript:void(0)"
                            class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary">
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".2s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Integrate OctansGen with your favorite tools to create a smooth and efficient workflow for
                            your video content.
                        </p>
                        <a href="javascript:void(0)"
                            class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary">
                ...
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12" data-wow-delay=".25s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                            Access all the essential tools you need for creating professional-quality short-form videos
                            with ease.
                        </p>
                        <a href="javascript:void(0)"
                            class="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary">
                ...
                <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                    <div class="mb-10 w-full">
                        <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
                            ...
                            <img src="/images/logo/logo-dark.png" alt="logo" class="max-w-full" />
                    ...
                    <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                        <div class="my-1 flex justify-center md:justify-end">
                            <p class="text-base text-gray-7">
                                ...
                                <a href="https://octansweb.com" rel="nofollow noopner" target="_blank"
